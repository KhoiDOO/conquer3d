...
public:
     ...
     */
    std::tuple<torch::Tensor, torch::Tensor> query(const torch::Tensor &query_aabb_mins,
     ...
     */
    std::tuple<torch::Tensor, torch::Tensor> query_ray(const torch::Tensor &ray_origins, const torch::Tensor &ray_dirs,
     ...
     */
    std::tuple<torch::Tensor, torch::Tensor, torch::Tensor> query_point(const torch::Tensor &query_points);
};
...
namespace bvh
{
     ...
     */
    __host__ void build(const uint32_t num_objects, const uint32_t num_nodes, const float3 *__restrict__ in_aabb_mins,
                        const float3 *__restrict__ in_aabb_maxs, float3 *__restrict__ bvh_aabb_mins,
                        float3 *__restrict__ bvh_aabb_maxs, int2 *__restrict__ bvh_children,
                        int *__restrict__ bvh_parents, int *__restrict__ object_ids);

    /**
     * @brief Dispatches parallel AABB-AABB query kernel on GPU.
     */
    __host__ void query(const uint32_t num_queries, const uint32_t num_objects, const float3 *__restrict__ query_mins,
                        ...
                        int64_t *__restrict__ out_object_ids, int64_t *__restrict__ hit_counter,
                        const int64_t max_capacity);

    /**
     * @brief Dispatches parallel BVH self-collision query kernel on GPU.
     */
    __host__ void query_self(const uint32_t num_objects, const float3 *__restrict__ bvh_aabb_mins,
                             const float3 *__restrict__ bvh_aabb_maxs, const int2 *__restrict__ bvh_children,
                             const int *__restrict__ object_ids, int64_t *__restrict__ out_query_ids,
                             int64_t *__restrict__ out_object_ids, int64_t *__restrict__ hit_counter,
                             const int64_t max_capacity);
     ...
     */
    __host__ void query_ray(const uint32_t num_queries, const uint32_t num_objects,
     ...
     */
    __host__ void query_point(const uint32_t num_queries, const uint32_t num_objects,
                              const float3 *__restrict__ query_points, const float3 *__restrict__ bvh_aabb_mins,
                              const float3 *__restrict__ bvh_aabb_maxs, const int2 *__restrict__ bvh_children,
                              const int *__restrict__ object_ids, int64_t *__restrict__ out_query_ids,
                              int64_t *__restrict__ out_object_ids, float *__restrict__ out_distances);
} // namespace bvh
