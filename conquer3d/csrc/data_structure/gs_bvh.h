...
public:
    ...
    query_voxel_pair(const torch::Tensor &vx_aabb_mins, const torch::Tensor &vx_aabb_maxs, const torch::Tensor &means,
                     const torch::Tensor &covis, const torch::Tensor &opacities, const torch::Tensor &gs_aabb_mins,
                     const torch::Tensor &gs_aabb_maxs, const torch::Tensor &contact_points,
                     const std::variant<float, torch::Tensor> &isos, const float ar_threshold, const float p_threshold,
                     const bool return_centroids, const int64_t max_capacity);

    /**
     * @brief Queries 3D Gaussian intersections with line segments / voxel edges.
     */
    std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>
    query_edge_pair(const torch::Tensor &edge_starts, const torch::Tensor &edge_ends, const torch::Tensor &means,
     ...
     */
    std::tuple<torch::Tensor, torch::Tensor> query_edge(const torch::Tensor &edge_starts,
