 ...
 */
static __inline__ __host__ __device__ float4x4 make_float4x4(float a00, float a01, float a02, float a03, float a10,
...
{
    return make_float4(a.x * m.m[0][0] + a.y * m.m[1][0] + a.z * m.m[2][0] + a.w * m.m[3][0],
...
{
    return make_float4(a.x * m.m[0][0] + a.y * m.m[0][1] + a.z * m.m[0][2] + a.w * m.m[0][3],
...
{
    return make_float3(a.x * m.m[0][0] + a.y * m.m[1][0] + a.z * m.m[2][0] + m.m[3][0],
