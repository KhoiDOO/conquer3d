...
marching_tetrahedra_wrapper(torch::Tensor grid_vertices, torch::Tensor tets, torch::Tensor vert_values,
                            ...
                            float iso, bool return_unique_edges)
{
    ...
    return mt::marching_tetrahedra(num_tets, p_grid_vertices, p_tets, p_vert_values, p_grid_normals, p_grid_colors, iso,
                                   grid_vertices.options(), tets.options(), return_unique_edges);
}
 ...
 */
void marching_tetrahedra_backward_wrapper(torch::Tensor unique_edges, torch::Tensor grid_vertices,
                                          ...
                                          float iso)
{
    ...
    mt::backward(n_verts, p_unique_edges, p_grid_vertices, p_grid_colors, p_values, p_adj_verts, p_adj_colors,
...
{
    m.def("marching_tetrahedra", &marching_tetrahedra_wrapper, py::arg("grid_vertices"), py::arg("tets"),
          py::arg("vert_values"), py::arg("grid_normals") = std::nullopt, py::arg("grid_colors") = std::nullopt,
    ...
    m.def("marching_tetrahedra_backward", &marching_tetrahedra_backward_wrapper, py::arg("unique_edges"),
          py::arg("grid_vertices"), py::arg("grid_colors"), py::arg("values"), py::arg("adj_verts"),
          py::arg("adj_colors"), py::arg("adj_values"), py::arg("adj_grid_colors"), py::arg("iso") = 0.0f,
          R"pbdoc(
