...
marching_tetrahedra_grid_wrapper(torch::Tensor grid_vertices, torch::Tensor voxels, torch::Tensor voxel_values,
                                 std::optional<torch::Tensor> grid_normals, std::optional<torch::Tensor> grid_colors,
                                 float iso, bool return_unique_edges)
{
    ...
    return mtg::marching_tetrahedra_grid(num_voxels, p_grid_vertices, p_voxels, p_voxel_values, p_grid_normals,
                                         p_grid_colors, iso, grid_vertices.options(), voxels.options(),
                                         return_unique_edges);
}
 ...
 */
void marching_tetrahedra_grid_backward_wrapper(torch::Tensor unique_edges, torch::Tensor grid_vertices,
                                               std::optional<torch::Tensor> grid_colors, torch::Tensor values,
                                               torch::Tensor adj_verts, std::optional<torch::Tensor> adj_colors,
                                               torch::Tensor adj_values, std::optional<torch::Tensor> adj_grid_colors,
                                               float iso)
{
    ...
    mtg::backward(n_verts, p_unique_edges, p_grid_vertices, p_grid_colors, p_values, p_adj_verts, p_adj_colors,
...
{
    m.def("marching_tetrahedra_grid", &marching_tetrahedra_grid_wrapper, py::arg("grid_vertices"), py::arg("voxels"),
    ...
    m.def("marching_tetrahedra_grid_backward", &marching_tetrahedra_grid_backward_wrapper, py::arg("unique_edges"),
